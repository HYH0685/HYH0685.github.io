var github_canlendar = (git_user, git_color) => {
  var git_githubapiurl = "https://github-calendar-python-api.vercel.app/api?" + git_user;
  var git_fixed = 'fixed';
  var git_px = 'px';
...
(function () {
  ...
  var git_purple = ['#d7dbe2', '#fdcdec', '#fc9bd9', '#fa6ac5', '#f838b2', '#f5089f', '#c4067e', '#92055e', '#540336', '#48022f', '#30021f'];
  var git_yellow = ['#d7dbe2', '#f9f4dc', '#f7e8aa', '#f7e8aa', '#f8df72', '#fcd217', '#fcc515', '#f28e16', '#fb8b05', '#d85916', '#f43e06'];
